...
SAMPLES=/mnt/fastdata/bo1ltd/Themeda-v2-MolEcol/mttree/alignment/Themeda_sample_RAGTAG-MT

# [2] CDS.bed and CDS_to_gene.txt (see "CDS_gff_to_bed.sh")
BED=/mnt/fastdata/bo1ltd/Themeda-v2-MolEcol/mttree/alignment/mt-CDS.BED
GENES=/mnt/fastdata/bo1ltd/Themeda-v2-MolEcol/mttree/alignment/mt-gene.BED
...
#mkdir ShortRead_to_alignment
cd ShortRead_to_alignment-ragtag.scaffold.500.organelle
